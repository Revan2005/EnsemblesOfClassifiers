...
public class Testowanie {
	...
	public Testowanie(ZespolKlasyfikatorow zespolKlasyfikatorow, ArrayList<Obiekt> daneTestowe){
		this.zespolKlasyfikatorow = zespolKlasyfikatorow;
	...
	public double[] testuj(){
		...
		for(int i=0; i<daneTestowe.size(); i++){
			...
			przewidywanaKlasa = zespolKlasyfikatorow.getClass(o);
