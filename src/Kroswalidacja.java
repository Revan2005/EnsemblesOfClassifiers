...
public class Kroswalidacja {
	...
	ZespolKlasyfikatorow zespolKLasyfikatorow;
	...
	public Kroswalidacja(int liczbaFoldow, ArrayList<Obiekt> dane, int liczbaSasiadow, String metryka, String metodaGlosowania,
						 String rodzajZespoluKlasyfikatorow, int liczbaKlasyfikatorowWZespole){
		lF = liczbaFoldow;
...
//==================================glowna czesc generowanie modelu i jego testowanie =================		
		for(int i=0; i<lF; i++){
			...
			if(rodzajZespoluKlasyfikatorow.equals("bagging"))
				zespolKLasyfikatorow = new ZespolKlasyfikatorowBagging(liczbaSasiadow, metryka, metodaGlosowania, daneUczace, liczbaKlasyfikatorowWZespole);
			else if(rodzajZespoluKlasyfikatorow.equals("boosting"))
				zespolKLasyfikatorow = new ZespolKlasyfikatorowBoosting(liczbaSasiadow, metryka, metodaGlosowania, daneUczace, liczbaKlasyfikatorowWZespole);

			//klasyfikator = new KlasyfikatorKNN(liczbaSasiadow, metryka, metodaGlosowania, daneUczace);//NaiveBayes.generujModel(daneUczace, czyZdyskretyzowane);
			testowanie = new Testowanie(zespolKLasyfikatorow, daneTestowe);
